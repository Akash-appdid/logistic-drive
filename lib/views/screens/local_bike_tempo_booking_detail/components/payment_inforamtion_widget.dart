...
class PaymentInformationWidgetOfLocalBikeTempo extends StatelessWidget {
  const PaymentInformationWidgetOfLocalBikeTempo({
    super.key,
  });
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "₹ ${formatPrice(controller.localBikeTempoBookingData?.totalPayableAmountForDriver?.toDouble() ?? 0)}",
                        style:
                            Theme.of(context).textTheme.displayMedium?.copyWith(
                                  color: Colors.black,
                                  fontSize: 14,
