...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  void initState() {
    super.initState();
    Timer.run(() async {
      await Get.find<BookingController>().getBookingDetail(id: widget.bookingId);
    });
  }
...
class UploadEpodWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BookingController>(initState: (_) {
      ...
      if (controller.bookingsDetailData?.bookingType == 'goods' && controller.bookingsDetailData?.status == 'delivered') {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                controller.bookingsDetailData?.epod != null ? 'Uploaded EPOD' : "Upload EPOD :",
                ...
                return CustomButton(
                  ...
                  onTap: controller.ePodFile == null
                      ...
                      : () async {
                          ...
                          log("$data");
                          await controller.uploadEpod(data: data).then((val) async {
                            if (val.isSuccess) {
